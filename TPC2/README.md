...
1.Listar compositores em ordem alfabética.

2.Contar o número de obras por período musical.

3.Exibir os títulos das obras organizados por período, ordenados alfabeticamente.


## 📌 Resultados
A seguir, apresenta-se um exemplo de saída, com conformidade com o input, gerado pela execução do programa `main.js` utilizando o ficheiro `obras.csv` disponibilizado pelos docentes.
